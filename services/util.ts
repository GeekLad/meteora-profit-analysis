...
//   private outputQueue: (ProcessedResult<R> | undefined)[] = [];
...
//     try {
//       while (this.processingMap.has(this.nextProcessIndex)) {
//         const results = await this.processingMap.get(this.nextProcessIndex)!;
//         const inputCount = this.inputQueue[this.nextProcessIndex].length;

//         this.outputQueue[this.nextProcessIndex] = {
//           inputCount,
//           output: results,
//         };
//         this.processingMap.delete(this.nextProcessIndex);
//         this.nextProcessIndex++;

//         this._checkAndResolveNext();
...
//       } else {
//         this._checkAndResolveNext(); // Ensure we resolve any pending next() calls
//       }
//     }
//   }

//   private _checkAndResolveNext(): void {
//     let contiguousResults: ProcessedResult<R>[] = [];

//     while (this.outputQueue[this.nextOutputIndex]) {
//       const nextResult = this.outputQueue[this.nextOutputIndex]!;

//       contiguousResults.push(nextResult);
//       delete this.outputQueue[this.nextOutputIndex];
//       this.nextOutputIndex++;
//     }

//     if (contiguousResults.length > 0 && this.resolveNext) {
...
//     if (this.inputQueue.length === 0 && this.processingMap.size === 0) {
...
//           try {
//             const results = await Promise.race<R[] | "timeout">([
//               promise,
//               new Promise<"timeout">((_, reject) =>
//                 setTimeout(() => reject("timeout"), 0),
//               ),
//             ]);
